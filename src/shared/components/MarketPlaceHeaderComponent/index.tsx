...
const newMainRoutes = [
  ...
  {
    title: 'Home',
    path: '/marketplace' //'/explore-nfts',
  },
  {
    title: 'All NFTs',
    path: '/marketplace/projects' //'/explore-nfts',
  },
  {
    title: 'Stats',
...
const MarketPlaceHeaderComponent = () => {
  ...
  const pathsForUser = ["/genpad", "/marketplace/projects", "/profile", "/marketplace", "/project", "/profile-detail", "/marketplace/projects/project-detail", "/assets/create", "/top-collections", "/marketplace/projects", "/collection", "/marketplace/cart", "/explore-nfts"]
  ...
  useEffect(() => {
    ...
    const localUserCart = JSON.parse(localStorage.getItem("user_cart") || "{}") as UserCart
    addLocalStorageCartItems(localUserCart)
    ...
    <div className="header homePageHeader">
      ...
      <div className="header__content homepage-header">
        ...
        <nav className='all-tabs'>
          ...
          <div className="other-routes-selection other-routes-space">
        ...
        >
          ...
          <div className="dropdown">
            <button className="btn btn-primary dropdown-toggle" type="button" id="dropdownMenuButton000" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
               <User className='navmenu' size={20} color="#fff" onClick={() => { history.push("/profile-detail") }} />
            </button>
            <div className="dropdown-menu" aria-labelledby="dropdownMasaenuButton">
              <a className="dropdown-item" onClick={() => { history.push("/userProfile") }}>Update Profile</a>
              <a className="dropdown-item" onClick={() => { history.push("/profile-detail") }}>User Profile</a>
            </div>
          </div>
          <Link to="/marketplace/cart" className='add-to-cart-header-redirect'>
            {/* <img src="/images/icons/shopping-cart-dark.png" alt="cart" /> */}
            <ShoppingCart className='navmenu' size={20} color="#fff" />
            {cartItems.length ? <span className="items-badge">{cartItems.length}</span> : null}
          </Link>
         </div>
        ...
        {mobileMenu ? <div className="menu-item-header">
          <div className="menu-items">
            <div className="other-routes-selection">
              ...
              {account !== null ? <ActiveBorder
                style={{ width: 177, marginLeft: '10px' }}
                key={2}
                active={false}>
                <NetworkButtonStyled
                  style={{ width: 'fit-content' }}
