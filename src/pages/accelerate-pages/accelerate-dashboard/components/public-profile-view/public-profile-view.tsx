...
import { RangeSlider } from '../partner-network/components/range-slider/range-slider';
...
const PublicProfileView = () => {
    ...
    const isPublicProfile = pathname.includes("/profile/public-profile")
    const isDashboard = pathname.includes("/profile/public-profile-view")
    ...
    return (
        <>
            <div>
                ...
                <DashbordTopSection symbioteScore={symbioteScore} setSymbioteScore={setSymbioteScore} />
                        ...
                        <>
                            <div className='profile-section d-flex align-items-center justify-content-between'>
                                ...
                                <div className='public-btn'>
                                    <button className='new-primary-button' onClick={() => history.push('/profile/public-profile-view')}><i className="ri-eye-fill me-2"></i>View as Public Profile</button>
                                </div>
                            </div>
                            <div className='text-center edit-form mt-lg-5 mt-md-3 mt-2'>
                                <p className='paragraph-new-medium' role='button' onClick={() => history.push('/forms/project-view/profile')}>Edit the form</p>
                            </div>
                        </>
                    }
                        ...
                        <div className='d-flex justify-content-between align-items-center'>
                            ...
                            {isPublicProfile ?
                                <div className='d-flex align-items-center'>
                                    <div className='duelist-img'><img src={Profile} alt="" /></div>
                                    <div className='duelist-name'>
                                        <h3 className=''>Duelist King</h3>
                            ...
                            <div className='form-slider mt-3'>
                                <div className='percentage-slider text-center m-auto d-flex'>
                                    <CircularProgressbar value={symbioteScore} text={`${Number(symbioteScore).toFixed(0)}`} background
                                        backgroundPadding={0}
                                        styles={buildStyles({
